...
test_that("test getCalibInterceptAndSlope", {
  ...
  actual <- getCalibInterceptAndSlope(dataset1, config = NULL, useBlock = 1)
...
test_that("test getCalibInterceptAndSlope for dataset with rows that should be excluded", {
  ...
  actual <- getCalibInterceptAndSlope(dataset2, config = NULL, useBlock = 1)
...
test_that("test calibrateNoDriftSingleDataset", {
  ...
  actual <- calibrateNoDriftSingleDataset(dataset1, config = NULL, block = 1)
...
test_that("test calibrateWithoutDriftCorrection", {
  ...
  actual <- calibrateWithoutDriftCorrection(list(df1 = dataset1), config = NULL)
