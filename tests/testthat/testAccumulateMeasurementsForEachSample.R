...
test_that("mean values are correct", {
  ...
  expected1 <- tribble(
    ~Line, ~`Identifier 1`, ~`Identifier 2`, ~block, ~delta.O18, ~delta.H2, ~sd.O18, ~sd.H2, ~d.Excess, ~sd.d.Excess, ~Sample,
    # -- / -------------- / -------------- / ----- / --------- / -------- / ------ / ----- / -------  / ----------- / -------
    1,     "C",             "x",             1,      2,          20,        1,       5,      20,        9.43,         1,
    2,     "A",             "y",             NA,     4.5,        0,         0.71,    0,      4.5,       5.66,         2,
    3,     "B",             "z",             2,      10,         -5,        1.41,    0.42,   10,        11.32,        3,
    4,     "C",             "x",             3,      -3,         0,         1.41,    2.83,   0,         11.66,        4
  )
...
test_that("use only last 2 injections to calculate average", {
  ...
  expected1 <- tribble(
    ~Line, ~`Identifier 1`, ~`Identifier 2`, ~block, ~delta.O18, ~delta.H2, ~sd.O18, ~sd.H2, ~d.Excess, ~sd.d.Excess, ~Sample,
    # -- / -------------- / -------------- / ----- / --------- / -------- / ------ / ----- / -------  / ----------- / -------
    1,     "C",             "x",             1,      2.5,        22.5,      0.71,    3.54,   22.5,      6.67,         1,
    2,     "A",             "y",             NA,     4.5,        0,         0.71,    0,      4.5,       5.66,         2,
    3,     "B",             "z",             2,      10,         -5,        1.41,    0.42,   10,        11.32,        3,
    4,     "C",             "x",             3,      -3,         0,         1.41,    2.83,   0,         11.66,        4
  )
