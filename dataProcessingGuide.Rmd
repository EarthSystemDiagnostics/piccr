...
For longer measurement runs Picarro devices exhibit drift (van Geldern and
...
$I_0$, slope $s_0$), and then applies Eq. (\ref{eq:calibration}). This is
...
calibration yields $I_0$ and $s_0$, the $b_3$ calibration $I_1$ and $s_1$. Then,
the rates are given by

\begin{align}
\alpha \simeq \frac{I_1 - I_0}{\Delta t},\\
\beta \simeq \frac{s_1 - s_0}{\Delta t}.
\end{align}
...
2.
if (use\_simple\_drift\_correction):
