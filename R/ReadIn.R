...
data_files=
    Sys.glob(paste(meta.info_folder$folder_path,meta.info_folder$fileID,sep=''))
...
file_indices=sort(unlist(sapply(meta.info_folder$meta.info_std$std_names,function(x){
...
#------------------------------------------------------------------------------------
# loop over standards by calling 'PassVector' and extract std data separated into
# the measurement blocks by calling 'GetStdBlocks' for each standard
...
#************************************
# GET STANDARD BLOCKS DATA FUNCTION *
#************************************
#
########################################
...
########################################
    ...
    ## ---------------------------------------------------------------------------
    ## split into sets corresponding to first, intermediate and final measurements
    ## -> number of measurements depending on standard and location in rack
    ## ---------------------------------------------------------------------------
